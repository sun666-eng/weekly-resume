...
What the recurring terms in Weekly Resume's interface actually mean.
...
Weekly Resume, GitHub, Docker, PostgreSQL, Better Auth, TanStack, Microsoft Word,
...
Legacy template identifiers such as Azurill, Bronzor, and Pikachu remain untranslated in code and
stored data for compatibility. User-facing template names come from localized template metadata.
