...
const expectHelpCopy = (root: HTMLElement) => {
	expect(within(root).getByText(/not sure what to write/i)).toBeInTheDocument();
...
describe("StylesheetEditorShell", () => {
	it("shows stylesheet editor help copy", () => {
		media.mobile = false;
