...
const PAGE_TITLE = "ATS Checker - Weekly Resume";
...
export const Route = createFileRoute("/_home/ats-checker")({
	...
	head: () => {
		...
		const canonicalUrl = origin ? new URL("/ats-checker", origin).toString() : "/ats-checker";
		const imageUrl = origin ? new URL("/opengraph/ats-checker.png", origin).toString() : "/opengraph/ats-checker.png";
