...
-- `local:oauth:<id>` fallback. Deployments using OAUTH_DISCOVERY_URL must replace the placeholder
-- after migration with the issuer from their discovery document, for example:
