/**
 * DeepSeek Harness plugin for Weekly Resume.
 * @module dsh-plugin-weekly-resume
 */
...
export const name = "weekly-resume";
...
/**
 * Connect a Weekly Resume account to the session.
...
export async function apply(ctx: Context, config: Config): Promise<void> {
	...
	ctx.systemPrompt.section({
		...
		name: `weekly-resume:${config.serverName}`,
		order: 150,
